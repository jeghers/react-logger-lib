...
var componentMatchesLevel = exports.componentMatchesLevel = function componentMatchesLevel(module, levelToMatch) {
  ...
  Object.keys(levels).sort().forEach(function (rule) {
...
var reset = function reset() {
  if (typeof localStorage !== 'undefined') {
    // we could just sort them ascending - and sequential match will leave us with proper
    // eslint-disable-next-line
    Object.keys(MODULE_LEVELS).forEach(function (key) {
      delete MODULE_LEVELS[key];
    });
...
var Logger = exports.Logger = { of: of, calls: LoggerInstance.calls, setOption: setOption, getOption: getOption, reset: reset };

exports.default = { of: of, calls: LoggerInstance.calls, setOption: setOption, getOption: getOption, reset: reset };
